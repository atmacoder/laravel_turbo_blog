    ...
    <form wire:submit.prevent="saveSettings">
        ...
        <div class="form-group  mt-4">
            ...
            <div class="picture-container">
                <img id="logo" src="{{ asset('/storage/') . '/' .$settings->logo}}" class="rounded-circle mb-3" style="width: 150px;"
                     alt="Avatar" />
        ...
        <div class="form-group mt-2 mb-2" wire:ignore>
            <div class="row>
                <div class="col-md-3"><label>{{__('main.background_header')}}</label></div>
        <div class="col-md-6"><div id="background_header"></div></div>
        </b-row>
</div>
<div class="form-group mt-2 mb-2" wire:ignore>
    <div class="row>
                <div class="col-md-3"><label>{{__('main.background_footer')}}</label></div>
<div class="col-md-6"><div id="background_footer"></div></div>
</div>
</div>

<div class="form-group mt-2 mb-2" wire:ignore>
    <div class="row>
                <div class="col-md-3"><label>{{__('main.background_card_header')}}</label></div>
<div class="col-md-6"><div id="background_card_header"></div></div>
</b-row>
</div>

<div class="form-group mt-2 mb-2" wire:ignore>
    <div class="row>
                <div class="col-md-3"><label for="colorInput4">{{__('main.links_color')}}</label></div>
<div class="col-md-6"><input id="colorInput4" data-jscolor="{}" value="{{$designSettings['links_color']}}" wire:model.lazy="designSettings.links_color"></div>
</b-row>

</div>
<div class="form-group mt-2 mb-2" wire:ignore>
    <div class="row>
                <div class="col-md-3"><label for="colorInput4">{{__('main.h1_color')}}</label></div>
<div class="col-md-6"><input id="colorInput4" data-jscolor="{}" value="{{$designSettings['h1_color']}}" wire:model.lazy="designSettings.h1_color"></div>
</b-row>
</div>

<div class="form-group mt-2 mb-2" wire:ignore>
    <div class="row>
                    <div class="col-md-3"><label for="colorInput4">{{__('main.menu_link_color')}}</label></div>
<div class="col-md-6"><input id="colorInput4" data-jscolor="{}" value="{{$designSettings['menu_link_color']}}" wire:model.lazy="designSettings.menu_link_color"></div>
</b-row>
</div>

<div class="form-group mt-2 mb-2" wire:ignore>
    <div class="row>
                    <div class="col-md-6"><label for="colorInput4">{{__('main.menu_hover_link_color')}}</label></div>
<div class="col-md-6"><input id="colorInput4" data-jscolor="{}" value="{{$designSettings['menu_hover_link_color']}}" wire:model.lazy="designSettings.menu_hover_link_color"></div>
</b-row>
</div>
